package com.digitalinnovationone.beer_api.demo.controller;
...
import com.digitalinnovationone.beer_api.demo.dto.QuantityDTO;
...
import static com.digitalinnovationone.beer_api.demo.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .content(asJsonString(beerDTO))) // simula um body enviado na requisição tipo o que fazemos no postman
    ...
    @Test
    void whenPOSTIsCalledWhithoutRequireFieldThenAnErrorIsReturned() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETIsCalledWithoutRegisteredNameThenNotFountStatusIsReturned() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
